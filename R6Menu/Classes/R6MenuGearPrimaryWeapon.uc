...
//Display Values
var     FLOAT                       m_2DWeaponWidth, m_2DWeaponHeight;
...
function Created()
{
    ...
    {
		m_AssignAll = R6MenuAssignAllButton(CreateWindow(class'R6MenuAssignAllButton',WinWidth - class'R6MenuAssignAllButton'.Default.UpRegion.W - 1, 0, class'R6MenuAssignAllButton'.Default.UpRegion.W, m_2DWeaponHeight));       
		m_AssignAll.ToolTipString	= Localize("Tip","GearRoomAssign","R6Menu");		
		m_AssignAll.ImageX			= 0;
		//m_AssignAll.ImageY			= 35;
    ...
    m_2DBullet = R6WindowButtonGear(CreateWindow(class'R6WindowButtonGear', m_2DWeaponWidth, 0, m_fBulletWidth, m_2DBulletHeight, self));
...
function Paint(Canvas C, FLOAT X, FLOAT Y)
{
   ...
   //Draw Lines between elements
    ...
    //Vertical
    DrawStretchedTextureSegment(C, m_2DWeaponWidth, 0, m_LinesRegion.W , WinHeight, 
								   m_LinesRegion.X, m_LinesRegion.Y, m_LinesRegion.W, m_LinesRegion.H, m_LinesTexture);
    //Horizontal line -- (+1 is to avoid superposition with vertical line)
    DrawStretchedTextureSegment(C, m_2DWeaponWidth + 1, m_2DWeaponGadget.WinTop , m_2DWeaponGadget.WinWidth - 1, 
								   m_LinesRegion.H , m_LinesRegion.X, m_LinesRegion.Y, m_LinesRegion.W, m_LinesRegion.H, m_LinesTexture);
...
defaultproperties
{
     ...
     m_2DWeaponWidth=130.000000
     m_2DWeaponHeight=79.000000
     m_fBulletWidth=65.000000
