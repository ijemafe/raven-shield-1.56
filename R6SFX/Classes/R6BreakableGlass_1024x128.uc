//============================================================================//
// Class            R6BreakableGlass_1024x128
...
//
//============================================================================//
class R6BreakableGlass_1024x128 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB1024x128Glass1
         ...
         StartLocationRange=(Y=(Min=-512.000000,Max=512.000000),Z=(Min=-64.000000,Max=64.000000))
         ...
         Name="MeshEmitterB1024x128Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB1024x128Glass1'
