//============================================================================//
// Class            R6BreakableGlass_256x210
...
//
//============================================================================//
class R6BreakableGlass_256x210 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB256x210Glass1
         ...
         StartLocationRange=(Y=(Min=-128.000000,Max=128.000000),Z=(Min=-105.000000,Max=105.000000))
         ...
         Name="MeshEmitterB256x210Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB256x210Glass1'
