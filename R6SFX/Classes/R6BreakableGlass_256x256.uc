//============================================================================//
// Class            R6BreakableGlass_256x256
...
//
//============================================================================//
class R6BreakableGlass_256x256 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB256x256Glass1
         ...
         StartLocationRange=(Y=(Min=-128.000000,Max=128.000000),Z=(Min=-128.000000,Max=128.000000))
         ...
         Name="MeshEmitterB256x256Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB256x256Glass1'
