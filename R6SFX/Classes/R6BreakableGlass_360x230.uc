//============================================================================//
// Class            R6BreakableGlass_360x230
...
//
//============================================================================//
class R6BreakableGlass_360x230 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB360x230Glass1
         ...
         StartLocationRange=(Y=(Min=-180.000000,Max=180.000000),Z=(Min=-115.000000,Max=115.000000))
         ...
         Name="MeshEmitterB360x230Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB360x230Glass1'
