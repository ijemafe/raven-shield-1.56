//============================================================================//
// Class            R6BreakableGlass_384x128
...
//
//============================================================================//
class R6BreakableGlass_384X128 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB384x128Glass1
         ...
         StartLocationRange=(Y=(Min=-192.000000,Max=192.000000),Z=(Min=-64.000000,Max=64.000000))
         ...
         Name="MeshEmitterB384x128Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB384x128Glass1'
