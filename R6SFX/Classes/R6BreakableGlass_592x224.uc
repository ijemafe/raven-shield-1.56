//============================================================================//
// Class            R6BreakableGlass_592x224
...
//
//============================================================================//
class R6BreakableGlass_592x224 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB592x224Glass1
         ...
         StartLocationRange=(Y=(Min=-296.000000,Max=296.000000),Z=(Min=-112.000000,Max=112.000000))
         ...
         Name="MeshEmitterB592x224Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB592x224Glass1'
