//============================================================================//
// Class            R6BreakableGlass_640x230
...
//
//============================================================================//
class R6BreakableGlass_640x230 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB640x230Glass1
         ...
         StartLocationRange=(Y=(Min=-320.000000,Max=320.000000),Z=(Min=-115.000000,Max=115.000000))
         ...
         Name="MeshEmitterB640x230Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB640x230Glass1'
