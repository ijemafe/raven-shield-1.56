//============================================================================//
// Class            R6BreakableGlass_768x128
...
//
//============================================================================//
class R6BreakableGlass_768X128 extends R6SFX;

defaultproperties
{
     AutoDestroy=True
     Begin Object Class=MeshEmitter Name=MeshEmitterB768x128Glass1
         ...
         StartLocationRange=(Y=(Min=-384.000000,Max=384.000000),Z=(Min=-64.000000,Max=64.000000))
         ...
         Name="MeshEmitterB768x128Glass1"
     End Object
     Emitters(0)=MeshEmitter'R6SFX.MeshEmitterB768x128Glass1'
